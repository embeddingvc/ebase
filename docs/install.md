...
Skills copied by the installer include **`ebase-setup`**, **`ebase-conversation-planner`**, **`ebase-send-connection-request`**, **`ebase-reply-to-post`**, and **`ebase-sync-persona`**. See [Claude skills](./skills.md).
